...
@return Order
*/
func (a *SpotApiService) CancelOrder(ctx context.Context) (Order, *http.Response, error) {
	var (
...
@return Order
*/
func (a *SpotApiService) GetOrder(ctx context.Context) (Order, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *SpotApiService) ListOrderBook(ctx context.Context, localVarOptionals *ListOrderBookOpts) (OrderBook, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
