...
> PortfolioAccount ListPortfolioAccounts(ctx, optional)
...
**optional** | **ListPortfolioAccountsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a ListPortfolioAccountsOpts struct
...
func main() {
    ...
    result, _, err := client.PortfolioApi.ListPortfolioAccounts(ctx, nil)
    if err != nil {
...
> map[string]bool ListAccountPortfolioMode(ctx, )
...
func main() {
    ...
    result, _, err := client.PortfolioApi.ListAccountPortfolioMode(ctx)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
> map[string]bool SetAccountPortfolioMode(ctx, portfolioMode)
...
func main() {
    ...
    portfolioMode := gateapi.PortfolioMode{} // PortfolioMode - 
    
    result, _, err := client.PortfolioApi.SetAccountPortfolioMode(ctx, portfolioMode)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
> PortfolioBorrowable GetPortfolioBorrowable(ctx, currency)
...
func main() {
    ...
    result, _, err := client.PortfolioApi.GetPortfolioBorrowable(ctx, currency)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
> PortfolioTransferable GetPortfolioTransferable(ctx, currency)
...
func main() {
    ...
    result, _, err := client.PortfolioApi.GetPortfolioTransferable(ctx, currency)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
> []UniLoan ListPortfolioUniLoanInterestRecords(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**optional** | **ListPortfolioUniLoanInterestRecordsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a ListPortfolioUniLoanInterestRecordsOpts struct
...
func main() {
    ...
    result, _, err := client.PortfolioApi.ListPortfolioUniLoanInterestRecords(ctx, nil)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
> CreatePortfolioLoan(ctx, portfolioLoan)
...
func main() {
    ...
    portfolioLoan := gateapi.PortfolioLoan{} // PortfolioLoan - 
    
    result, _, err := client.PortfolioApi.CreatePortfolioLoan(ctx, portfolioLoan)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
> []PortfolioLoanRecord ListPortfolioLoanRecords(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**optional** | **ListPortfolioLoanRecordsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a ListPortfolioLoanRecordsOpts struct
...
func main() {
    ...
    result, _, err := client.PortfolioApi.ListPortfolioLoanRecords(ctx, nil)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
[**[]PortfolioLoanRecord**](PortfolioLoanRecord.md)
...
> []UniLoanInterestRecord ListPortfolioLoanInterestRecords(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**optional** | **ListPortfolioLoanInterestRecordsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a ListPortfolioLoanInterestRecordsOpts struct
...
func main() {
    ...
    result, _, err := client.PortfolioApi.ListPortfolioLoanInterestRecords(ctx, nil)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
